...
test('filter by name, min and max employees', async function() {
	let companies = await Company.findAll({ name: 'c3', minEmployees: 2, maxEmployees: 3 });
	expect(companies).toEqual([
		{
			handle: 'c3',
			name: 'C3',
...
test('throw error if invalid min > max', async function() {
	try {
...
test('filter and nothing is found', async function() {
...
describe('get', function() {
	test('works', async function() {
		...
		expect(company).toEqual({
			...
			logoUrl: 'http://c1.img',
			jobs: [
				{ id: testJobs[0], title: 'Job1', salary: 100, equity: '0.1' },
				{ id: testJobs[1], title: 'Job2', salary: 200, equity: '0.2' },
				{ id: testJobs[2], title: 'Job3', salary: 300, equity: '0' },
				{ id: testJobs[3], title: 'Job4', salary: null, equity: null }
			]
		});
	});
